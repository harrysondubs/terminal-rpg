            ...
            if npc_def.name not in existing_npc_names:
                npc_repo.create(
                    NPC(
                        ...
                        ac=npc_def.ac,
                        attack_mod=npc_def.attack_mod,
                        damage_dice_count=npc_def.damage_dice_count,
                        damage_dice_sides=npc_def.damage_dice_sides,
                        initiative_mod=npc_def.initiative_mod,
                        level=npc_def.level,
                        xp=npc_def.xp,
                        gold=npc_def.gold,
